...
class GPSLinearization(Node):
    ...
    def gps_callback(self, msg: NavSatFix):
        ...
        x, y, z = geodetic2enu(msg.latitude, msg.longitude, msg.altitude, self.ref_lat, self.ref_lon, self.ref_alt, deg=True)
        self.pos_pub.publish(Vector3Stamped(header=msg.header, vector=Vector3(x=x, y=y, z=z)))
