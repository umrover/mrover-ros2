...
def main(args=None):
    ...
    parser.add_argument('msg_type', type=str, help='Message type (e.g., std_msgs/msg/String or geometry_msgs/msg/Twist)')
    ...
    try:
        publisher = RandomMessagePublisher(
            parsed_args.topic,
            parsed_args.msg_type,
            parsed_args.rate
        )
