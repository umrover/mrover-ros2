...
import rclpy
from lie import SE3
from mrover.msg import Position, Velocity
...
class DebugArmPublisher(Node):
    ...
    def typing_send_goal(self):
        typing_goal = TypingPosition.Goal(x=0.1, y=0.005)
