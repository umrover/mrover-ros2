...
class ROSInterface:
    def __init__(self, subsystem: str, producer: str, consumer: str,
                 iface_type: str, name: str, msg_type: str, frequency: str = "",
                 notes: str = ""):
...
def generate_icd_report(discovered: Dict[str, List[Tuple[str, str, str]]],
    ...
    # Header
    rows.append(['Subsystem', 'Producer', 'Consumer', 'Type', 'Name',
                 'Frequency', 'Definition Link', 'Definition', 'Notes'])
