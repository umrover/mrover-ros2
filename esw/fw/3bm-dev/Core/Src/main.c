...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, MOTOR_DIR_5_Pin|MOTOR_DIR_3_Pin|MOTOR_DIR_2_Pin|MOTOR_DIR_1_Pin
                          |MOTOR_DIR_0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, CAN_TX_LED_Pin|MOTOR_DIR_4_Pin|CAN_STB_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : CAN_RX_LED_Pin */
  GPIO_InitStruct.Pin = CAN_RX_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CAN_RX_LED_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : MOTOR_DIR_5_Pin MOTOR_DIR_3_Pin MOTOR_DIR_2_Pin MOTOR_DIR_1_Pin
                           MOTOR_DIR_0_Pin */
  GPIO_InitStruct.Pin = MOTOR_DIR_5_Pin|MOTOR_DIR_3_Pin|MOTOR_DIR_2_Pin|MOTOR_DIR_1_Pin
                          |MOTOR_DIR_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : CAN_TX_LED_Pin MOTOR_DIR_4_Pin */
  GPIO_InitStruct.Pin = CAN_TX_LED_Pin|MOTOR_DIR_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
